pipeline {
    ...
    stages {
        ...
        stage('CloudFormation On Cloud') 
        {
            ...
            aws cloudformation create-stack --stack-name mystacknew --template-body file://cloudformation.yaml --parameters ParameterKey=KeyPairName,ParameterValue=node.js --region us-east-1
            '''
            }
        }
    }
